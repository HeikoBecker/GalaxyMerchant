...
/*package*/ class Num_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public Num_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.num$Tpjx;
